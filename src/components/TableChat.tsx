...
export function TableChat() {
  ...
  return (
    <section className="gothic-panel flex h-[min(820px,calc(100vh-7rem))] min-h-[560px] flex-col overflow-hidden rounded-sm border border-bone/15 bg-background/35">
