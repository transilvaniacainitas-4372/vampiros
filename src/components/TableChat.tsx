...
export function TableChat() {
  ...
  return (
    <section className="gothic-panel flex h-[min(720px,calc(100vh-13rem))] min-h-[460px] flex-col overflow-hidden rounded-sm border border-bone/15 bg-background/35">
