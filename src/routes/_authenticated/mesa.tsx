      ...
      <header className="gothic-nav border-b border-border/50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex flex-wrap gap-4 justify-between items-center">
          ...
          <nav className="flex flex-wrap items-center gap-3">
            <Link to="/meu-personagem" className="gothic-menu-link font-display uppercase tracking-widest text-xs">Minha ficha</Link>
            <Link to="/mesa" className="gothic-menu-link gothic-menu-link-active font-display uppercase tracking-widest text-xs">Mesa</Link>
            <MessagesMenu />
